...
class PerformanceAnalyticsService implements PerformanceAnalyticsServiceInterface
{
    public function __construct(
        ...
        private readonly EquityCurvePointRepositoryInterface        $equityCurvePointRepository,
    ...
    {
        $query = $this->equityCurvePointRepository->queryByUser($userId);
    ...
    {
        $query = $this->closedPositionRepository->queryByUser($userId);
